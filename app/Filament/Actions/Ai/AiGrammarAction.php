...
class AiGrammarAction extends Action
{
    protected string $aiLocale = 'ms';

    public static function make(?string $id = null): static
    {
        return parent::make($id ?? 'ai_grammar');
    }
        ...
        $this
            ...
            ->action(function (Get $schemaGet, Set $schemaSet) use ($locale): void {
                ...
                Notification::make()->success()
                    ->title(__('ai_admin.grammar_applied'))->send();
            });
    }

    public static function isAiEditorEnabled(): bool
    {
        return filter_var(
            Setting::get('ai_admin_editor_enabled', config('ai.admin_editor_enabled', false)),
            FILTER_VALIDATE_BOOLEAN,
        ) && app(AiService::class)->isAvailable();
    }
}
