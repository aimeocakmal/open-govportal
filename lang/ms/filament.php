...
return [
    ...
    'settings' => [
        'site_info' => [
            ...
            'theme' => 'Tema',
            'theme_desc' => 'Pilih tema lalai untuk laman web awam.',
            'default_theme' => 'Tema Lalai',
            'analytics' => 'Analitik',
            'analytics_desc' => 'Konfigurasi skrip penjejakan dan integrasi analitik.',
            'google_analytics_id' => 'ID Google Analytics',
            'custom_analytics_script' => 'Skrip Analitik Tersuai',
            'custom_analytics_script_help' => 'Tampal kod penjejakan tersuai di sini (cth: Facebook Pixel, Hotjar, dll.). Ia akan disuntik ke dalam <head> setiap halaman awam.',
            'data_retention' => 'Penyimpanan Data',
            'data_retention_desc' => 'Konfigurasi tempoh log aktiviti disimpan sebelum diarkib dan dipadam.',
            'activity_log_retention_days' => 'Penyimpanan Log Aktiviti (hari)',
            'activity_log_retention_days_help' => 'Log aktiviti lebih lama daripada ini akan diarkib dan dipadam setiap bulan (1hb setiap bulan). Minimum 30 hari.',
    ...
    'resource' => [
        ...
        'activity_logs' => [
            ...
            'date_from' => 'Dari',
            'date_until' => 'Hingga',
            'archive_action' => 'Arkib Log Lama',
            'archive_confirm_heading' => 'Arkib & Padam Log Aktiviti Lama',
            'archive_confirm_description' => 'Ini akan mengarkib dan memadam :count log aktiviti yang lebih lama daripada :days hari. Arkib akan disimpan sebagai fail ZIP ke storan media yang dikonfigurasikan.',
            'archive_confirm_button' => 'Arkib & Padam',
            'archive_success' => 'Pengarkiban berjaya diselesaikan.',
            'purge_completed' => ':count log aktiviti diarkib ke :archive dan dipadam.',
            'purge_nothing' => 'Tiada log aktiviti untuk diarkib atau dipadam.',
        ],
    ],
];
