...
return [
    ...
    'settings' => [
        'site_info' => [
            ...
            'theme' => 'Theme',
            'theme_desc' => 'Select the default theme for the public website.',
            'default_theme' => 'Default Theme',
            'analytics' => 'Analytics',
            'analytics_desc' => 'Configure tracking scripts and analytics integrations.',
            'google_analytics_id' => 'Google Analytics ID',
            'custom_analytics_script' => 'Custom Analytics Script',
            'custom_analytics_script_help' => 'Paste custom tracking code here (e.g. Facebook Pixel, Hotjar, etc.). This will be injected into the <head> of every public page.',
            'data_retention' => 'Data Retention',
            'data_retention_desc' => 'Configure how long activity logs are kept before being archived and deleted.',
            'activity_log_retention_days' => 'Activity Log Retention (days)',
            'activity_log_retention_days_help' => 'Activity logs older than this will be archived and deleted monthly (1st of each month). Minimum 30 days.',
    ...
    'resource' => [
        ...
        'activity_logs' => [
            ...
            'date_from' => 'From',
            'date_until' => 'Until',
            'archive_action' => 'Archive Old Logs',
            'archive_confirm_heading' => 'Archive & Purge Old Activity Logs',
            'archive_confirm_description' => 'This will archive and delete :count activity logs older than :days days. The archive will be saved as a ZIP file to the configured media storage.',
            'archive_confirm_button' => 'Archive & Delete',
            'archive_success' => 'Archive completed successfully.',
            'purge_completed' => ':count activity logs archived to :archive and deleted.',
            'purge_nothing' => 'No activity logs to archive or delete.',
        ],
    ],
];
